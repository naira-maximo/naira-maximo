...
font=('Calibre', 10), width=13, height=2, activebackground='#c5a8b0', command=resposta)
button.place(relx=0.59, rely=0.09)
...
font=('Calibre', 10), width=13, height=2, activebackground='#c5a8b0', command=(enviar_notas, enviar_retorno))
